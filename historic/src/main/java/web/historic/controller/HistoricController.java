...
public class HistoricController {
    ...
    @GetMapping(value = "/historic/all", produces = MediaType.APPLICATION_JSON_VALUE)
    public List<Historic> getAllHistoryPatient(@RequestParam int id) throws HistoryNotFoundException{
