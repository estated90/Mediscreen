...
DatePickerAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function DatePickerAllModule_Factory(t) { return new (t || DatePickerAllModule)(); }, providers: [], imports: [[CommonModule, DatePickerModule], DatePickerModule] });
...
TimePickerAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function TimePickerAllModule_Factory(t) { return new (t || TimePickerAllModule)(); }, providers: [], imports: [[CommonModule, TimePickerModule], TimePickerModule] });
...
DateRangePickerAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function DateRangePickerAllModule_Factory(t) { return new (t || DateRangePickerAllModule)(); }, providers: [], imports: [[CommonModule, DateRangePickerModule], DateRangePickerModule] });
...
DateTimePickerAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function DateTimePickerAllModule_Factory(t) { return new (t || DateTimePickerAllModule)(); }, providers: [], imports: [[CommonModule, DateTimePickerModule], DateTimePickerModule] });
